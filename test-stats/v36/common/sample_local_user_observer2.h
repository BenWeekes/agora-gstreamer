...
class SampleLocalUserObserver2 : public agora::rtc::ILocalUserObserver {
 ...
 public:
  ...
  void onAudioSubscribeStateChanged(const char* channel,  agora::user_id_t userId, agora::rtc::STREAM_SUBSCRIBE_STATE oldState, 
                       agora::rtc::STREAM_SUBSCRIBE_STATE newState, int elapseSinceLastState) override {}
